/*
  # Extensive Lessons and Quizzes (Title-based, Idempotent)
  Inserta lecciones y 3 quizzes por lección para todos los módulos,
  referenciando módulos por su título y evitando duplicados.

  Idempotencia:
  - Lecciones: NOT EXISTS por (module_id, title)
  - Quizzes: NOT EXISTS por (lesson_id, order_index)
*/

-- =====================
-- Módulo 1: Conceptos Básicos
-- =====================
-- Lección: Cambios de Estado y Energía
INSERT INTO lessons (module_id, title, content, order_index, estimated_minutes)
SELECT m.id, 'Cambios de Estado y Energía',
...
AND NOT EXISTS (
  SELECT 1 FROM lessons l WHERE l.module_id = m.id AND l.title = 'Cambios de Estado y Energía'
);
...
WHERE m.title = 'Conceptos Básicos' AND l.title = 'Cambios de Estado y Energía'
AND NOT EXISTS (
  SELECT 1 FROM quizzes q WHERE q.lesson_id = l.id AND q.order_index = 1
);
...
WHERE m.title = 'Conceptos Básicos' AND l.title = 'Cambios de Estado y Energía'
AND NOT EXISTS (
  SELECT 1 FROM quizzes q WHERE q.lesson_id = l.id AND q.order_index = 2
);
...
WHERE m.title = 'Conceptos Básicos' AND l.title = 'Cambios de Estado y Energía'
AND NOT EXISTS (
  SELECT 1 FROM quizzes q WHERE q.lesson_id = l.id AND q.order_index = 3
);

-- Lección: Propiedades Intensivas vs Extensivas
INSERT INTO lessons (module_id, title, content, order_index, estimated_minutes)
SELECT m.id, 'Propiedades Intensivas vs Extensivas',
...
WHERE m.title = 'Conceptos Básicos'
AND NOT EXISTS (
  SELECT 1 FROM lessons l WHERE l.module_id = m.id AND l.title = 'Propiedades Intensivas vs Extensivas'
);
...
SELECT l.id,
       ...
       10, 1
FROM lessons l JOIN modules m ON l.module_id = m.id
WHERE m.title = 'Conceptos Básicos' AND l.title = 'Propiedades Intensivas vs Extensivas'
AND NOT EXISTS (
  SELECT 1 FROM quizzes q WHERE q.lesson_id = l.id AND q.order_index = 1
);
...
-- Lección: Métodos de Separación de Mezclas
INSERT INTO lessons (module_id, title, content, order_index, estimated_minutes)
SELECT m.id, 'Métodos de Separación de Mezclas',
       '<h2>Separación</h2><p>Filtración, decantación, destilación, cromatografía para separar componentes de mezclas.</p>',
       9, 18
FROM modules m
WHERE m.title = 'Conceptos Básicos'
AND NOT EXISTS (
  SELECT 1 FROM lessons l WHERE l.module_id = m.id AND l.title = 'Métodos de Separación de Mezclas'
);
...
SELECT l.id,
       ...
       10, 1
FROM lessons l JOIN modules m ON l.module_id = m.id
WHERE m.title = 'Conceptos Básicos' AND l.title = 'Métodos de Separación de Mezclas'
AND NOT EXISTS (
  SELECT 1 FROM quizzes q WHERE q.lesson_id = l.id AND q.order_index = 1
);
...
-- =====================
-- Lección: Polaridad y Electronegatividad
INSERT INTO lessons (module_id, title, content, order_index, estimated_minutes)
SELECT m.id, 'Polaridad y Electronegatividad',
...
AND NOT EXISTS (
  SELECT 1 FROM lessons l WHERE l.module_id = m.id AND l.title = 'Polaridad y Electronegatividad'
);
...
SELECT l.id,
       ...
       10, 1
FROM lessons l JOIN modules m ON l.module_id = m.id
WHERE m.title = 'Enlaces y Compuestos' AND l.title = 'Polaridad y Electronegatividad'
AND NOT EXISTS (
  SELECT 1 FROM quizzes q WHERE q.lesson_id = l.id AND q.order_index = 1
);
...
-- Lección: Geometría Molecular (VSEPR)
INSERT INTO lessons (module_id, title, content, order_index, estimated_minutes)
SELECT m.id, 'Geometría Molecular (VSEPR)',
       '<h2>VSEPR</h2><p>Repulsión de pares electrónicos define geometría: lineal, trigonal plana, tetraédrica, etc.</p>',
       7, 20
FROM modules m
WHERE m.title = 'Enlaces y Compuestos'
AND NOT EXISTS (
  SELECT 1 FROM lessons l WHERE l.module_id = m.id AND l.title = 'Geometría Molecular (VSEPR)'
);
...
SELECT l.id,
       ...
       10, 1
FROM lessons l JOIN modules m ON l.module_id = m.id
WHERE m.title = 'Enlaces y Compuestos' AND l.title = 'Geometría Molecular (VSEPR)'
AND NOT EXISTS (
  SELECT 1 FROM quizzes q WHERE q.lesson_id = l.id AND q.order_index = 1
);
...
-- Lección: Interacciones Intermoleculares
INSERT INTO lessons (module_id, title, content, order_index, estimated_minutes)
SELECT m.id, 'Interacciones Intermoleculares',
       '<h2>Fuerzas</h2><p>Puentes de hidrógeno, dipolo-dipolo y fuerzas de dispersión (London).</p>',
       8, 18
FROM modules m
WHERE m.title = 'Enlaces y Compuestos'
AND NOT EXISTS (
  SELECT 1 FROM lessons l WHERE l.module_id = m.id AND l.title = 'Interacciones Intermoleculares'
);
...
SELECT l.id,
       ...
       10, 1
FROM lessons l JOIN modules m ON l.module_id = m.id
WHERE m.title = 'Enlaces y Compuestos' AND l.title = 'Interacciones Intermoleculares'
AND NOT EXISTS (
  SELECT 1 FROM quizzes q WHERE q.lesson_id = l.id AND q.order_index = 1
);
...
-- =====================
-- Lección: Ley de Velocidad y Orden de Reacción
INSERT INTO lessons (module_id, title, content, order_index, estimated_minutes)
SELECT m.id, 'Ley de Velocidad y Orden de Reacción',
...
AND NOT EXISTS (
  SELECT 1 FROM lessons l WHERE l.module_id = m.id AND l.title = 'Ley de Velocidad y Orden de Reacción'
);
...
SELECT l.id,
       ...
       10, 1
FROM lessons l JOIN modules m ON l.module_id = m.id
WHERE m.title = 'Reacciones Químicas' AND l.title = 'Ley de Velocidad y Orden de Reacción'
AND NOT EXISTS (
  SELECT 1 FROM quizzes q WHERE q.lesson_id = l.id AND q.order_index = 1
);
...
-- Lección: Rendimiento y Reactivo Limitante
INSERT INTO lessons (module_id, title, content, order_index, estimated_minutes)
SELECT m.id, 'Rendimiento y Reactivo Limitante',
       '<h2>Estequiometría aplicada</h2><p>El reactivo limitante determina el máximo de producto; rendimiento = (real/teórico)×100.</p>',
       7, 22
FROM modules m
WHERE m.title = 'Reacciones Químicas'
AND NOT EXISTS (
  SELECT 1 FROM lessons l WHERE l.module_id = m.id AND l.title = 'Rendimiento y Reactivo Limitante'
);
...
SELECT l.id,
       ...
       10, 1
FROM lessons l JOIN modules m ON l.module_id = m.id
WHERE m.title = 'Reacciones Químicas' AND l.title = 'Rendimiento y Reactivo Limitante'
AND NOT EXISTS (
  SELECT 1 FROM quizzes q WHERE q.lesson_id = l.id AND q.order_index = 1
);
...
-- Lección: Tipos de Reacciones Orgánicas Básicas
INSERT INTO lessons (module_id, title, content, order_index, estimated_minutes)
SELECT m.id, 'Tipos de Reacciones Orgánicas Básicas',
       '<h2>Orgánica básica</h2><p>Adición, sustitución y eliminación en hidrocarburos y derivados sencillos.</p>',
       8, 24
FROM modules m
WHERE m.title = 'Reacciones Químicas'
AND NOT EXISTS (
  SELECT 1 FROM lessons l WHERE l.module_id = m.id AND l.title = 'Tipos de Reacciones Orgánicas Básicas'
);
...
SELECT l.id,
       ...
       10, 1
FROM lessons l JOIN modules m ON l.module_id = m.id
WHERE m.title = 'Reacciones Químicas' AND l.title = 'Tipos de Reacciones Orgánicas Básicas'
AND NOT EXISTS (
  SELECT 1 FROM quizzes q WHERE q.lesson_id = l.id AND q.order_index = 1
);
...
-- =====================
-- Lección: Equilibrio Químico
INSERT INTO lessons (module_id, title, content, order_index, estimated_minutes)
SELECT m.id, 'Equilibrio Químico',
...
AND NOT EXISTS (
  SELECT 1 FROM lessons l WHERE l.module_id = m.id AND l.title = 'Equilibrio Químico'
);
...
SELECT l.id,
       ...
       10, 1
FROM lessons l JOIN modules m ON l.module_id = m.id
WHERE m.title = 'Química Avanzada' AND l.title = 'Equilibrio Químico'
AND NOT EXISTS (
  SELECT 1 FROM quizzes q WHERE q.lesson_id = l.id AND q.order_index = 1
);
...
-- Lección: Ácido-Base: pH y Neutralización
INSERT INTO lessons (module_id, title, content, order_index, estimated_minutes)
SELECT m.id, 'Ácido-Base: pH y Neutralización',
       '<h2>pH</h2><p>pH = -log[H+]; neutralización ácido-base, cálculo de pH en soluciones fuertes y débiles.</p>',
       8, 28
FROM modules m
WHERE m.title = 'Química Avanzada'
AND NOT EXISTS (
  SELECT 1 FROM lessons l WHERE l.module_id = m.id AND l.title = 'Ácido-Base: pH y Neutralización'
);
...
SELECT l.id,
       ...
       10, 1
FROM lessons l JOIN modules m ON l.module_id = m.id
WHERE m.title = 'Química Avanzada' AND l.title = 'Ácido-Base: pH y Neutralización'
AND NOT EXISTS (
  SELECT 1 FROM quizzes q WHERE q.lesson_id = l.id AND q.order_index = 1
);
...
-- Lección: Solubilidad y Producto de Solubilidad (Ksp)
INSERT INTO lessons (module_id, title, content, order_index, estimated_minutes)
SELECT m.id, 'Solubilidad y Producto de Solubilidad (Ksp)',
...
WHERE m.title = 'Química Avanzada'
AND NOT EXISTS (
  SELECT 1 FROM lessons l WHERE l.module_id = m.id AND l.title = 'Solubilidad y Producto de Solubilidad (Ksp)'
);
...
SELECT l.id,
       ...
       10, 1
FROM lessons l JOIN modules m ON l.module_id = m.id
WHERE m.title = 'Química Avanzada' AND l.title = 'Solubilidad y Producto de Solubilidad (Ksp)'
AND NOT EXISTS (
  SELECT 1 FROM quizzes q WHERE q.lesson_id = l.id AND q.order_index = 1
);
